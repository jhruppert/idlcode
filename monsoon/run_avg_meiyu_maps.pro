...
;LEVEL SELECTION
  psel=700;500;925;700 700 is the winner of 600, 700, 800, 850, 925
  izlev=(where(dims.pres eq psel))[0]
  psel_wind=700;925;500;700
...
;  for it=ndavg-1,ndavg-1 do begin
    ...
    if iavg_all then begin
      ...
      t_stamp='d'+strtrim(it,2);+'-d avg'
      t_stamp_fig=string(all_ndavg,format='(i2.2)')+'-d-avg'
    endif
